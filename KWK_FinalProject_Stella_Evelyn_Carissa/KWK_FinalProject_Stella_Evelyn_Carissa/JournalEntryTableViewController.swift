...
class JournalEntryTableViewController: UITableViewController {
    ...
    func createEntry() -> [JournalEntry] {
         ...
         let july = JournalEntry()
         july.response = "Learn Swift"

         let june = JournalEntry()
         june.response = "Walk the Dog"

         return [july, june]
    }

    var listOfEntries : [JournalEntry] = []

    override func viewDidLoad() {
        super.viewDidLoad()

    listOfEntries = createEntry()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = eachEntry.response
